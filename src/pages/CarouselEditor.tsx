...
export default function CarouselEditor() {
  ...
  const buildTextClass = (style: TextStyle) => {
    ...
    if (style.underline && style.strikethrough) parts.push("underline line-through");
    else if (style.underline) parts.push("underline");
    else if (style.strikethrough) parts.push("line-through");
        ...
        <div className="relative" style={{ width: previewW + 64 }}>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {/* Slide number */}
              <div className="absolute bottom-3 right-4 text-swan/40 text-xs">{currentIndex + 1}/{slides.length}</div>
            </motion.div>
          </AnimatePresence>
